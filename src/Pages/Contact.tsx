const Contact = () => {
  return (
    <div className="contact">
      ...
      <p>
        Whether you're stuck in your coding journey, want to recommend a topic for the roadmap, or just want to share feedback,
      ...
      <p>
        We usually respond within 24-48 hours. Stay connected and keep coding!
      </p>
    </div>
  )
}
